            ...
            <div class="setupRightSide">
                <div class="innerLink">
                    <ul class="innerNav">
                        ...
                        <li class="item"><a href="<?= FRONT_SITE . '/settings/cancel-policy' ?>">Cancel Policy</a></li>
                        <li class="item active"><a href="<?= FRONT_SITE . '/settings/refund-policy' ?>">Refund Policy</a></li>
                    </ul>
                </div>
