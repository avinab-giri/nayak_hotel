...
<body class="g-sidenav-show  bg-gray-100">
            ...
            <div class="setupRightSide">
                <div class="innerLink">
                    <ul class="innerNav">
                        ...
                        <li class="item active"><a href="<?= FRONT_SITE.'/settings/page-link' ?>">Page Link</a></li>
    ...
    <script>
        ...
        $(document).ready(()=>{
            ...
            $(document).on('submit', '#pageLinkDataForm', function(e){
                e.preventDefault();
                var data = $(this).serialize();
                var formData = `${data}&request_type=pageLinkSubmit`;
