...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <section id="setupSection">
            ...
            <div class="setupRightSide">
                <div class="innerLink">
                    <ul class="innerNav">
                        <li class="item active"><a href="<?= FRONT_SITE . '/settings/personal-settings' ?>">Personal Settings</a></li>
                    </ul>
                </div>
                <div class="detailView scrollBar"> </div>
            </div>
        </section>
    ...
    <script>
        ...
        $('.ganeralNav .personalSetting').addClass('active');
