    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <section id="setupSection">
            ...
            <div class="setupRightSide">
                <div class="innerLink">
                    <ul class="innerNav">
                        <li class="item active"><a href="<?= FRONT_SITE.'/settings/image-public' ?>">Public</a></li>
                        <li class="item"><a href="<?= FRONT_SITE.'/settings/image-private' ?>">Private</a></li>
                    </ul>
                </div>
