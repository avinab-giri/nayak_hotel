    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container">
            ...
            <div class="reservationNav sNavBar">
                ...
                $noShowLink = FRONT_SITE.'/no-show';
                $voidLink = FRONT_SITE.'/void';
                $stayOverviewLink = FRONT_SITE.'/stay-view';
                
                $leftNav = '<div class="mainNavContent">
                    <ul id="loadReservationCountContent">
                         <li><a id="New" href="javascript:void(0)" class="reservationTab py-3 active">New</a> </li>
                        <li><a id="all" class="py-3" href="'.$reservationLink.'">All Reservations<span></span></a></li>
                        <li><a id="noShow" href="'.$noShowLink.'" class=" py-3" >No Show</a></li>     
                        <li><a id="void" href="'.$voidLink.'" class=" py-3" >Void</a></li>                    
                    </ul>
            ...
            <div class="row">
                <div class="col-12">
                    <div id="resorvationContent"><div class="loadingIcon">
                            <img src="<?= FRONT_SITE_IMG . '/loading.gif' ?>" alt="">
                        </div></div>
                    <div id="loadAddResorvation"><div class="loadingIcon">
                            <img src="<?= FRONT_SITE_IMG . '/loading.gif' ?>" alt="">
                        </div></div>
                </div>
            </div>
