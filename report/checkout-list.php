...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg scrollBar">
        ...
        <div class="container">
            ...
            <?php
            echo backNavbarUi('', 'Check In List');
            ?>
    ...
    <script>
        ...
        $('#SearchByDateFrom').on('change', function(e){
            var date = $(this).val();
            loadCackOutListReport(date);
        });

        function loadCackOutListReport(date = '', name = '') {
            var data = `request_type=loadCackOutListReport&name=${name}&date=${date}`;
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit', '#checkInFilterForm', function(e) {
                ...
                var name = $('#name').val();
                loadCackOutListReport(date, name);
            });
